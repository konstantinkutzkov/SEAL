...
def get_llm_model(model_name="https://www.kaggle.com/models/google/universal-sentence-encoder/TensorFlow2/multilingual/2"): #model_name="paraphrase-multilingual-MiniLM-L12-v2"):
...
def get_LLM_embeddings(llm_model, corpus, emb_dim):
    ...
    embeddings = llm_model(sentences) #llm_model.encode(sentences)
